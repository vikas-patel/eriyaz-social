    ...
    protected void onFinishInflate() {
        ...
        mAdapter = new RecyclerView.Adapter() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.record_share_transfer_item, parent, false);
        ...
        mRecyclerView.addItemDecoration(new SpaceItemDecoration(getResources().getDimensionPixelSize(R.dimen.record_share_menu_item_space)));
    }

    public void show() {
        int height = getResources().getDimensionPixelSize(R.dimen.record_share_menu_height);
