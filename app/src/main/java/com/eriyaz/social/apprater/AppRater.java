...
public class AppRater
{
    ...
    private static final int     DEFAULT_DAYS_BEFORE_RATE       = 1;
    ...
    private boolean shouldAppShowRatingOnStart()
    {
        ...
        long daysPastSinceStart= ((currentTime - storedTime) / (1000 * 60 * 60 * 1));
    ...
    private void showAppraterDialog()
    {
        ...
        }).setNegativeButton(buttonLater, new OnClickListener()
        {
        ...
        }).setNeutralButton(buttonNever, new OnClickListener()
        {
            public void onClick(DialogInterface dialog, int which)
            {
                if (callbackHandler != null)
